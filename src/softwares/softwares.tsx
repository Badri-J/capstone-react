...
const SoftwaresPage: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(
        "http://localhost:8080/software/getAllSoftwares"
  ...
  return (
    <div className="softwares">
      ...
      <h1 className="heading_soft">Software Details</h1>
      <table className="tablesoft tablesoft-striped bdr">
        <thead>
          <tr>
